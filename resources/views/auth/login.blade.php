...
<head>
  <meta charset="utf-8">
    ...
    <link rel="icon" href="https://sm-software.herokuapp.com/backend/images/favicon.ico">

    <title>School Management X - Log in </title>
  
	<!-- Vendors Style-->
	<link rel="stylesheet" href="https://sm-software.herokuapp.com/backend/css/vendors_css.css">
...
<body class="hold-transition theme-primary bg-gradient-primary">
	...
	<!-- Vendor JS -->
	<script src="https://sm-software.herokuapp.com/backend/js/vendors.min.js"></script>
    <script src="https://sm-software.herokuapp.com/backend/assets/icons/feather-icons/feather.min.js"></script>	
...
{{-- <script defer src="{{ asset('backend/fontawesome/js/all.js') }}"></script> --}}
